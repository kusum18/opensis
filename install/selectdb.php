...
<body>
<div class="heading">Thanks for providing MySQL Connection Information</div>
<div style="background-image:url(images/step2.gif); background-repeat:no-repeat; background-position:50% 20px; height:270px;">
  <form name='selectdb' id='selectdb' method='post' action="upgrade.php">
    <table border="0" cellspacing="6" cellpadding="3" align="center">
      <tr>
        <td  align="center" style="padding-top:36px; padding-bottom:16px">Step 2 of 3</td>
      </tr>
      <tr>
        <td align="center" valign="top"><strong>Please select the Database from 
		the list that you want to use.</strong></td>
      </tr>
      <tr>
      ...
      <tr>
        <td align="center"><input type="submit" value="Save & Next" class=btn_wide name="Add_DB"  /></td>
      </tr>
    </table>
  </form>
</div>
