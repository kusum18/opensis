...
#  the Free Software Foundation, version 3 of the License. See license.txt.
#
...
if(WAREHOUSE_PHP==0)
{
	...
	if(!file_exists($StudentPicturesPath.$DefaultSyear))
	{
		mkdir($StudentPicturesPath.$DefaultSyear);
	}
							...
							function doOnload()
							{
							 ...
							 try
							 {
								...
								if(layer = document.getElementById('LOx_layer'))
								{
									...
									layer.style.top = 0;
									//Visibility has been made hidden as it was not working properly
