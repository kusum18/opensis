...
echo '<H4>Welcome, '.User('NAME').', to the '.$CentreTitle.'</H4>';
...
echo '<TR>';
echo '<TD>';
echo SelectInput($student['CUSTOM_200000000'],'values[STUDENTS][CUSTOM_200000000]','Gender',array('M'=>'Male','F'=>'Female'));
echo '</TD>';
echo '<TD>';
echo _makeInput('values[STUDENTS][CUSTOM_200000002]','Hebrew Name');
echo '</TD>';
echo '</TR>';
echo '<TR><TD colspan=2 align=center>';
echo '<BR>'._makeInput('values[STUDENTS][CUSTOM_200000006]','Physician','','size=30');
echo '<BR>'._makeInput('values[STUDENTS][CUSTOM_200000007]','Physician Phone','','size=30');
echo '<BR>'._makeInput('values[STUDENTS][CUSTOM_200000008]','Preferred Hospital','','size=30');
echo '<BR><TEXTAREA name=values[STUDENTS][CUSTOM_200000009] cols=26 rows=5 style="color: BBBBBB;" onfocus=\'if(this.value=="Medical Comments") this.value=""; this.style.color="000000";\' onblur=\'if(this.value=="") {this.value="Medical Comments"; this.style.color="BBBBBB";}\'">Medical Comments</TEXTAREA>';
echo '</TD></TR>';
echo '</TABLE>';
echo '<BR>';
$_CENTRE['DrawHeader'] = 'E8E8E9';
