...
ListOutput($staff_RET,$columns,'Teacher who takes '.$menus_RET[$_REQUEST['menu_id']][1]['TITLE'].' counts','Teachers who take '.$menus_RET[$_REQUEST['menu_id']][1]['TITLE'].' counts');
echo '</TD></TR>';

$totals = array_values($totals);
unset($totals[0]);
echo '<TR><TD>';
ListOutput($totals,array('DESCRIPTION'=>'Item','COUNT'=>'Total Count'),'Item Total','Item Totals');
echo '</TD></TR></TABLE>';
