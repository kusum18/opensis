...
if(UserStudentID())
{
    ...
    if(!$_REQUEST['modfunc']){    
       ...
       AND mp.school_id = '".UserSchool()."' order by mp.post_end_date";
        ...
        $mpselect .= "<SELECT name=mp_id onchange='document.forms[1].submit();'>";
        ...
        echo '</FORM>';
            ...
            $sms_grade_level = TextInput($gmp[$mp_id]['grade_level'],"SMS_GRADE_LEVEL","",'size=3 maxlength=3 class=cell_floating');
            ...
            if ($mp_id=="0"){
                ...
                echo '<tr><td align=right width=50%>Grade:</td><td width=50%>'.$sms_grade_level.'</td></tr><tr><td class=clear></td></tr></table>';
                $tabs = array();
                ...
                if ($_REQUEST['tab_id']=='grades' || $_REQUEST['tab_id'] == ''){
                    ...
                    $LO_columns = array('COURSE_TITLE'=>'Course Name',
                                        ...
                                        'WEIGHTED_GP'=>'Grade Points',
                                        'UNWEIGHTED_GP'=>'Unweighted Grade Points',
