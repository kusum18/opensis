...
#**************************************************************************
	...
	//frmvalidator.addValidation("tables['.$_REQUEST['marking_period_id'].'][SORT_ORDER]","req","Please enter the Short Order");
...
try
{  
   if (false==isDate(pem, ped, pey))
   {
   alert("Please enter the Grade Posting End Date");
   pem.focus();
   return false;
   }
}   
