...
DrawHeaderHome(PrepareDateSchedule($start_date,'_start').' - '.PrepareDateSchedule($end_date,'_end'),'<INPUT type=submit class=btn_medium value=Go onclick=\'formload_ajax("add");\'>');
echo '</FORM>';
