...
if($_REQUEST['students'])
{
	...
	{
		$sql = "SELECT CONCAT(s.LAST_NAME,', ',s.FIRST_NAME) AS FULL_NAME,s.STUDENT_ID,s.CUSTOM_200000004,ssm.GRADE_ID
	...
	$RET = DBGet(DBQuery($sql),array('CUSTOM_200000004'=>'Birthdate','GRADE_ID'=>'GetGrade'));

	$link = array();
	$link['FULL_NAME']['link'] = "Modules.php?modname=Scheduling/Schedule.php";
	$link['FULL_NAME']['variables'] = array('student_id'=>'STUDENT_ID');
	ListOutput($RET,array('FULL_NAME'=>'Student','GRADE_ID'=>'Grade','CUSTOM_200000004'=>'Birthdate'),'Student','Students',$link,array(),$LO_options);
	echo '</TD>';
}
