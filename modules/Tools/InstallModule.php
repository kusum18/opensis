...
if($_REQUEST['action']=='install' && $_FILES['file']['name'])
{
	...
	'.$msg.'
	<form enctype="multipart/form-data" action="Modules.php?modname=Tools/InstallModule&action=install" method="POST">';

	//echo '<input type="hidden" name="MAX_FILE_SIZE" value="100000" /> ';

	echo 'Select the module zip file to upload: <input name="file" type="file" /><br /><br>
	<input type="submit" value="Install Module" class=btn_large />
	</form>
	</fieldset>
';
    }
...
<fieldset style="width:400px"><legend><b>Upload your file</b></legend>
'.$msg.'
<form enctype="multipart/form-data" action="Modules.php?modname=Tools/InstallModule.php&action=install" method="POST">';
