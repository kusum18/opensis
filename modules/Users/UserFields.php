...
/*
	...
	frmvalidator.addValidation("tables[new][TITLE]","alphabetic", "First name allows only alphabetic value");
  	frmvalidator.addValidation("tables[new][TITLE]","maxlen=50", "Max length for First Name is 100");
